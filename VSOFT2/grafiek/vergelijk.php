...
<body>
    <form action="" method="POST">
        <label for="klant1Grafiek">Klant 1, Kies het jaar dat je wilt zien uit jouw grafiek:</label>

        <select name="klant1Grafiek">
            <?php
            for ($j = 2019; $j <= 2021; $j++){
                if ($j == intval($_POST['klant1Grafiek'])){
        ...
        <label for="klant2Grafiek">Klant 1, Kies het jaar dat je wilt zien uit Klant 2 zijn grafiek:</label>
        <select name="klant2Grafiek">
            <?php
            for ($k = 2019; $k <= 2021; $k++){
                if ($k == intval($_POST['klant2Grafiek'])){
